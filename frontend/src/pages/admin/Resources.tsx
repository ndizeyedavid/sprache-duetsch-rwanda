      ...
      <Panel>
        ...
        {isStaff ? (
          <form onSubmit={handleCreate} className="mt-6 space-y-3">
            ...
            <input value={excerpt} onChange={(event) => setExcerpt(event.target.value)} placeholder="Excerpt (optional)" className="input input-sm w-full rounded-field border-line bg-base-200" />
            <label className="block">
              ...
              <input
                ...
                disabled={uploading}
                className="file-input file-input-sm w-full rounded-field border-line bg-base-200"
              />
            </label>
            ...
            <textarea required value={body} onChange={(event) => setBody(event.target.value)} placeholder="Body — plain text, line breaks kept" rows={4} className="textarea w-full rounded-field border-line bg-base-200" />
            {formError ? (
      ...
      {isStaff ? (
        <Panel>
          ...
          <form onSubmit={handleCreate} className="space-y-3">
            <input required value={question} onChange={(event) => setQuestion(event.target.value)} placeholder="Question" className="input input-sm w-full rounded-field border-line bg-base-200" />
            <textarea required value={answer} onChange={(event) => setAnswer(event.target.value)} placeholder="Answer" rows={4} className="textarea w-full rounded-field border-line bg-base-200" />
            {formError ? (
              <p role="alert" className="text-xs font-medium text-error">
                {formError}
              </p>
