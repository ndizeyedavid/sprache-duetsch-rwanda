...
export function AdminTransactions() {
 ...
 <select required value={payStudent} onChange={(event) => setPayStudent(event.currentTarget.value)} className="select w-full rounded-field border-line bg-base-200">
 ...
 <input required value={payAmount} onChange={(event) => setPayAmount(event.currentTarget.value)} inputMode="numeric" placeholder="25000" className="input input w-full rounded-field border-line bg-base-200" />
 </label>
 <label className="block">
 ...
 <input value={payReference} onChange={(event) => setPayReference(event.currentTarget.value)} placeholder="e.g. MOMO-123456 (optional)" className="input input w-full rounded-field border-line bg-base-200" />
 </label>
 {payError ? (
 ...
 <input required value={disValue} onChange={(event) => setDisValue(event.currentTarget.value)} inputMode="numeric" placeholder="e.g. 5000 or 10" className="input input w-full rounded-field border-line bg-base-200" />
 </label>
 </div>
 </div>
 <label className="block">
