...
const StudentLesson = lazy(() =>
  import("./pages/student/LessonView").then((module) => ({
    default: module.StudentLesson,
  })),
);
const StudentActivity = lazy(() =>
  import("./pages/student/StudentActivity").then((module) => ({
...
const Grades = lazy(() =>
  import("./pages/student/Grades").then((module) => ({
    default: module.Grades,
  })),
);
const Assignments = lazy(() =>
  import("./pages/student/Assignments").then((module) => ({
    default: module.Assignments,
  })),
);
const AssignmentDetail = lazy(() =>
  import("./pages/student/AssignmentDetail").then((module) => ({
    default: module.AssignmentDetail,
  })),
);
const Profile = lazy(() =>
...
// ---------------------------------------------------------------------------
const Messages = lazy(() =>
  import("./pages/shared/Messages").then((module) => ({
    default: module.Messages,
  })),
);
const Activity = lazy(() =>
  import("./pages/shared/Activity").then((module) => ({
    default: module.Activity,
  })),
);
const Settings = lazy(() =>
  import("./pages/shared/Settings").then((module) => ({
...
const TeacherDashboard = lazy(() =>
  import("./pages/teacher/Dashboard").then((module) => ({
    default: module.TeacherDashboard,
  })),
);
const TeacherClasses = lazy(() =>
  import("./pages/teacher/Classes").then((module) => ({
    default: module.TeacherClasses,
  })),
);
const TeacherSchedule = lazy(() =>
  import("./pages/teacher/Schedule").then((module) => ({
    default: module.TeacherSchedule,
  })),
);
const TeacherAttendance = lazy(() =>
  import("./pages/teacher/Attendance").then((module) => ({
    default: module.TeacherAttendance,
  })),
);
const TeacherGrading = lazy(() =>
  import("./pages/teacher/Grading").then((module) => ({
    default: module.TeacherGrading,
  })),
);
const TeacherReports = lazy(() =>
  import("./pages/teacher/Reports").then((module) => ({
    default: module.TeacherReports,
  })),
);
const TeacherContent = lazy(() =>
  import("./pages/teacher/Content").then((module) => ({
...
const TeacherPeople = lazy(() =>
  import("./pages/teacher/People").then((module) => ({
    default: module.TeacherPeople,
  })),
);
...
const AdminFinance = lazy(() =>
  import("./pages/admin/Finance").then((module) => ({
    default: module.AdminFinance,
  })),
);
...
const AdminClasses = lazy(() =>
  import("./pages/admin/Classes").then((module) => ({
    default: module.AdminClasses,
  })),
);
const AdminEnrolments = lazy(() =>
  import("./pages/admin/Enrolments").then((module) => ({
    default: module.AdminEnrolments,
  })),
);
const AdminPeople = lazy(() =>
  import("./pages/admin/People").then((module) => ({
    default: module.AdminPeople,
  })),
);
...
const AdminOrganisation = lazy(() =>
  import("./pages/admin/Organisation").then((module) => ({
    default: module.AdminOrganisation,
  })),
);
  ...
  return (
    <Suspense fallback={<PageFallback />}>
      ...
      <Routes>
        ...
        <Route
          element={<RequireRole roles={[...ADMIN_ROLES, ...FINANCE_ROLES]} />}
        >
          <Route element={<AppLayout />}>
