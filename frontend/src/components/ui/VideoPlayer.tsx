...
export function VideoPlayer({
 ...
 aria-label={label}
 >
 <span className="flex size-14 items-center justify-center rounded-full bg-base-100 text-night sm:size-16">
 <FiPlay className="translate-x-0.5 text-xl" aria-hidden />
 </span>
 <span className="text-sm font-semibold drop- sm:text-base">{label}</span>
 </button>
 </div>
 );
}
